...
From the plot above it seems more women are under lots of stress (3 0r more in the stress scale). In order to investigate that, it was treated each group separately (women and men) to how much of each group declared to experience a lot of daily stress. 
